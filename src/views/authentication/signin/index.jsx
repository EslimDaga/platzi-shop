...
const SignIn = () => {
  ...
  useEffect(() => {
    showErrorAlert &&
      error?.statusCode &&
      toast.error("Correo electronico y/o contraseña incorrectos");
  }, [showErrorAlert]);
  ...
  return (
    <div className="flex justify-between min-h-screen font-sans bg-platzi-primary-background">
      <Toaster
        ...
        richColors
      />
      <div className="relative hidden w-1/2 bg-center bg-cover lg:block bg-platzi-primary-purple">
        <div className="absolute flex flex-col items-center justify-center w-full bottom-20">
          ...
          <div className="max-w-md text-center">
            ...
            <p className="font-light leading-7 text-gray-200">
              Platzi Shop es una plataforma donde puedes comprar y vender tus
              productos online.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 max-w-2xl mx-auto">
        <div className="flex flex-col p-6 text-white lg:px-14 xl:px-24">
          <img
            ...
            className="self-center w-32 pb-10 lg:pb-20 md:self-end"
            alt="logo_platzi"
          />
          <div>
            ...
            <div className="flex flex-wrap items-center justify-between pt-6 gap-y-4 gap-x-6 whitespace-nowrap">
              <button className="flex items-center justify-center flex-1 px-3 py-4 bg-white border border-gray-400 rounded-xl whitespace-nowrap hover:bg-gray-50 focus:outline-none focus:ring-gray-100 focus:ring-4">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 25 24"
            ...
            <div className="flex items-center justify-between pt-6">
              ...
              <span className="px-4 font-light tracking-wider text-white">
                o
              </span>
              <hr className="w-full border-gray-200" />
            </div>
            <form onSubmit={formikSignIn.handleSubmit}>
                ...
                <div
                  className={
                    ...
                    (formikSignIn.touched.email && formikSignIn.errors.email
                      ...
                      : loading &&
                        " opacity-50 cursor-not-allowed hover:border-gray-400")
                  }
                >
                  ...
                  <input
                    ...
                    className={
                      "w-full p-4 font-light border-0 focus:outline-none focus:ring-0 bg-platzi-primary-background " +
              ...
              <div className="flex items-center justify-between pt-4">
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="remember"
                    className="pl-4 font-light text-white"
                  >
                    Recordarme
                  </label>
                </div>
              ...
              <div className="pt-6">
                <button
                  ...
                  type="submit"
                  className={
                    "flex items-center justify-center w-full px-8 py-4 text-white shadow-lg bg-platzi-primary-purple rounded-xl hover:bg-platzi-secondary-purple focus:ring-0 focus:outline-none" +
                    (loading
                      ? " opacity-50 cursor-not-allowed bg-platzi-secondary-purple"
                      : "")
                  }
                >
                  {loading ? (
            ...
            <div className="pt-4">
              <div className="flex flex-wrap items-center justify-center pt-4 text-center gap-y-2">
                <span className="text-sm text-gray-300 lg:text-base">
                  © {new Date().getFullYear()} Platzi Shop. <br /> Todos los
                  derechos reservados.
                </span>
              </div>
            </div>
