      ...
      <div className="flex-1 max-w-2xl mx-auto">
        <div className="flex flex-col p-4 text-white lg:px-14 xl:px-24">
          <img
            ...
            className="self-center w-32 pb-10 lg:pb-4 md:self-end"
            alt="logo_platzi"
          />
          <div>
            ...
            <form onSubmit={formikSignUp.handleSubmit}>
              ...
              <div className="pt-4">
                <label htmlFor="passwordConfirmation" className="font-light">
            ...
            <div className="pt-4">
              <div className="font-light text-center text-white">
                ...
                <Link
                  to="/iniciar-sesion"
                  className="font-normal text-platzi-primary-green hover:text-platzi-primary-green"
                >
                  Inicia sesión
                </Link>
              </div>
